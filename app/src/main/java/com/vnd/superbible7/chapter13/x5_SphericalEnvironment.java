...
public class x5_SphericalEnvironment extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x5_SphericalEnvironment(Context context) {
        super(context);
    ...
    private void initialize(GL10 gl) {
        ...
        final String fragmentShaderSourceCode =
                "#version 320 es" +
                        ...
                        "fragColor = texture(textureSampler, r.xy * m + vec2(0.5));" +
                        "}";
        ...
        texture[0] = textureHelper.load2DTexture(R.raw.spheremap1);
        texture[1] = textureHelper.load2DTexture(R.raw.spheremap2);
        texture[2] = textureHelper.load2DTexture(R.raw.spheremap3);
    ...
    private void display() {
        ...
        Matrix.rotateM(modelViewMatrix, 0, (float) (currentTime * 19.3f), 0.0f, 1.0f, 0.0f);
        Matrix.rotateM(modelViewMatrix, 0, (float) (currentTime * 21.1f), 0.0f, 0.0f, 1.0f);
