...
public class x6_EquirectangularEnvironment extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x6_EquirectangularEnvironment(Context context) {
        super(context);
    ...
    private void initialize(GL10 gl) {
        ...
        final String fragmentShaderSourceCode =
                "#version 320 es" +
                        ...
                        "fragColor = texture(uTextureSampler, tc);" +
                        "}";
        ...
        texture[0] = textureHelper.load2DTexture(R.raw.equirectangularmap1);
