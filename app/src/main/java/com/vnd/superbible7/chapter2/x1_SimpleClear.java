...
public class x1_SimpleClear extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    private GestureDetector gestureDetector = null;

    public x1_SimpleClear(Context context) {
        super(context);
