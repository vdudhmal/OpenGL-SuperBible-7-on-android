package com.vnd.superbible7.chapter2;
...
public class x2_SinglePoint extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    private final float[] perspectiveProjectionMatrix = new float[16];
    private GestureDetector gestureDetector = null;
    private int shaderProgramObject = 0;

    public x2_SinglePoint(Context context) {
        super(context);
    ...
    private void display() {
        ...
        GLES32.glClearBufferfv(GLES32.GL_COLOR, 0, red, 0);
