...
public class x1_MovingTriangle extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    private final float[] perspectiveProjectionMatrix = new float[16];
    private final Timer timer = new Timer();
    private GestureDetector gestureDetector = null;
    private int shaderProgramObject = 0;

    public x1_MovingTriangle(Context context) {
        super(context);
    ...
    private void display() {
        ...
        // Calculate the attributes using sin and cos functions
        float[] attrib = {
                (float) Math.sin(currentTime) * 0.45f, // x-coordinate
                (float) Math.cos(currentTime) * 0.25f, // y-coordinate
                0.0f,                                 // z-coordinate
                0.0f                                  // w-coordinate
        };
        ...
        GLES32.glVertexAttrib4fv(0, attrib, 0);
