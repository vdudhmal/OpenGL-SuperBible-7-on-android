...
public class x2_TessellatedTriangle extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x2_TessellatedTriangle(Context context) {
        super(context);
