...
public class x4_FragmentColor extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    private final float[] perspectiveProjectionMatrix = new float[16];
    private GestureDetector gestureDetector = null;
    private int shaderProgramObject = 0;
    private boolean bInterpolateColor = false;
    private Uniforms uniforms;

    public x4_FragmentColor(Context context) {
        super(context);
    ...
    public boolean onSingleTapConfirmed(@NonNull MotionEvent event) {
        bInterpolateColor = !bInterpolateColor;
        return true;
    }
    ...
    private void initialize(GL10 gl) {
        ...
        final String fragmentShaderSourceCode =
                "#version 320 es" +
                        ...
                        "in vec4 oColor;" +
                        "out vec4 fragColor;" +
                        "uniform int bInterpolateColor;" +
                        "void main(void)" +
                        "{" +
                        "if (bInterpolateColor == 1)" +
                        "{" +
                        "fragColor =  vec4(" +
    ...
    private void display() {
        ...
        GLES32.glUniform1i(uniforms.bInterpolateColor, bInterpolateColor ? 1 : 0);
    ...
    private static class Uniforms {
        private int bInterpolateColor = -1;

        private void loadUniformLocations(int programId) {
            bInterpolateColor = GLES32.glGetUniformLocation(programId, "bInterpolateColor");
        }
    }
}
