...
public class x2_SimpleTexturing extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x2_SimpleTexturing(Context context) {
        super(context);
    ...
    private void initialize(GL10 gl) {
        ...
        final String fragmentShaderSourceCode =
                "#version 320 es" +
                        ...
                        "void main(void)" +
                        "{" +
                        "vec2 uv = gl_FragCoord.xy / vec2(textureSize(textureSampler, 0));" +
        ...
        texture[0] = textureHelper.generateColorPattern();
