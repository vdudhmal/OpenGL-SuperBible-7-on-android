...
public class x4_TextureCoordinates extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x4_TextureCoordinates(Context context) {
        super(context);
    ...
    private void initialize(GL10 gl) {
        ...
        final String fragmentShaderSourceCode =
                "#version 320 es" +
                        ...
                        "void main(void)" +
                        "{" +
                        "fragColor = texture(textureSampler, oTextureCoordinates * vec2(3.0, 1.0));" +
                        "}";
        ...
        texture[1] = textureHelper.load2DTexture(R.raw.pattern1);
