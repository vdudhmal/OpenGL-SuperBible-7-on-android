...
public class x11_MultipleViewports extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x11_MultipleViewports(Context context) {
        super(context);
    ...
    private void display() {
        ...
        float viewportWidth = (7.0f * windowWidth) / 16.0f;
        float viewportHeight = (7.0f * windowHeight) / 16.0f;

        // Set up matrices for each viewport
        ...
        for (int i = 0; i < 4; i++) {
            ...
            // Final MVP matrix for each viewport
        ...
        for (int i = 0; i < 4; i++) {
            // Set up four viewports
            switch (i) {
                case 0:
                    GLES32.glViewport(0, 0, (int) viewportWidth, (int) viewportHeight);  // Lower left
                    break;

                case 1:
                    GLES32.glViewport((int) (windowWidth - viewportWidth), 0, (int) viewportWidth, (int) viewportHeight);  // Lower right
                    break;

                case 2:
                    GLES32.glViewport(0, (int) (windowHeight - viewportHeight), (int) viewportWidth, (int) viewportHeight);  // Upper left
                    break;

                case 3:
                    GLES32.glViewport((int) (windowWidth - viewportWidth), (int) (windowHeight - viewportHeight), (int) viewportWidth, (int) viewportHeight);  // Upper right
                    break;
            }

            // Use the corresponding matrix for this viewport
