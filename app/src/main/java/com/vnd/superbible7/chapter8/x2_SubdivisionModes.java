...
public class x2_SubdivisionModes extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    private final float[] perspectiveProjectionMatrix = new float[16];
    private final int[] maxTesselationLevel = new int[1];
    private final int[] shaderProgramObject = new int[3];
    private final int NO_PROGRAMS = 3;
    ...
    private int edge1Subdivisions = 2;
    private int edge2Subdivisions = 4;
    private int edge3Subdivisions = 3;
    private int edge4Subdivisions = 1;

    public x2_SubdivisionModes(Context context) {
        super(context);
