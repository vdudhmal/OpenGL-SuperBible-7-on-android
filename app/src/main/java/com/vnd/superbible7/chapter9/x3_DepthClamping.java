...
public class x3_DepthClamping extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x3_DepthClamping(Context context) {
        super(context);
    ...
    private void initialize(GL10 gl) {
        ...
        final String vertexShaderSourceCode =
                "#version 320 es" +
                        ...
                        "void main(void)" +
                        "{" +
                        "oNormal = normalize(mat3(modelViewMatrix) * aNormal);" +
                        "oColor = aVertex * 2.0 + vec4(0.5, 0.5, 0.5, 0.0);" +
                        "gl_Position = projectionMatrix * modelViewMatrix * aVertex * vec4(vec3(explodeFactor), 1.0);" +
                        "}";
    ...
    private void display() {
        ...
        //GLES32.glEnable(GLES32.GL_DEPTH_CLAMP);
        ...
        GLES32.glUniform1f(uniforms.explodeFactor, (float) (Math.sin((float) currentTime * 8.0f) * Math.cos((float) currentTime * 6.0f) * 0.7f + 1.1f));
    ...
    private static class Uniforms {
        ...
        private void loadUniformLocations(int programId) {
            ...
            explodeFactor = GLES32.glGetUniformLocation(programId, "explodeFactor");
        }
    }
}
