...
public class x8_LineSmoothing extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public x8_LineSmoothing(Context context) {
        super(context);
    ...
    private void display() {
        ...
        // GLES32.glDisable(GLES32.GL_LINE_SMOOTH);
